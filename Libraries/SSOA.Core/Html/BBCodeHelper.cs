...
using SSOA.Core.Html.CodeFormatter;

namespace SSOA.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.SSOACommerce.com]my site[/url]
                // becomes: <a href="http://www.SSOACommerce.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.SSOACommerce.com[/url]
                // becomes: <a href="http://www.SSOACommerce.com">http://www.SSOACommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.SSOACommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.SSOACommerce.com/Content/Images/Image.jpg"></img>
