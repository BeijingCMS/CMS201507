...
namespace SSOA.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into SSOACommerce, 
                ...
                //The issue is described here: http://www.SSOAcommerce.com/boards/t/10969/SSOA-20-plugin.aspx?p=4#51318
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.SSOAcommerce.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual string GetStoreHost(bool useSsl)
        {
            ...
            if (DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                var storeContext = EngineContext.Current.Resolve<ITenantContext>();
                var currentStore = storeContext.CurrentTenant;
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new SSOAException("SSOACommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["SSOA.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["SSOA.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["SSOA.IsPOSTBeingDone"] = value;
            }
        }
