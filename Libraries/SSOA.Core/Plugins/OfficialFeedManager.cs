...
{
    /// <summary>
    /// Official feed manager (official plugins from www.SSOACommerce.com site)
    /// </summary>
    public partial class OfficialFeedManager : IOfficialFeedManager
    {
        ...
        public virtual IList<OfficialFeedCategory> GetCategories()
        {
            ...
            const string feedUrl = "http://www.SSOAcommerce.com/extensionsxml.aspx?getCategories=1";
        ...
        public virtual IList<OfficialFeedVersion> GetVersions()
        {
            ...
            const string feedUrl = "http://www.SSOAcommerce.com/extensionsxml.aspx?getVersions=1";
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            var feedUrl = string.Format("http://www.SSOAcommerce.com/extensionsxml.aspx?category={0}&version={1}&price={2}&pageIndex={3}&pageSize={4}&searchTerm={5}",
