...
namespace SSOA.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class SSOAEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(SSOAConfig config)
        {
            ...
            builder.RegisterInstance(config).As<SSOAConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(SSOAConfig config)
        {
            //register dependencies
