...
namespace SSOA.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have SSOACommerce 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<SSOAObjectContext>(tablesToValidate, customCommands.ToArray());
