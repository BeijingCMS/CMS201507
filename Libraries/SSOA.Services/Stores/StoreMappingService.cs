...
namespace SSOA.Services.Stores
{
    /// <summary>
    ...
    public partial class StoreMappingService : IStoreMappingService
    {
        ...
        /// {1} : entity name
        /// </remarks>
        private const string STOREMAPPING_BY_ENTITYID_NAME_KEY = "SSOA.storemapping.entityid-name-{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STOREMAPPING_PATTERN_KEY = "SSOA.storemapping.";
        ...
        {
            return Authorize(entity, _storeContext.CurrentTenant.Id);
        }
