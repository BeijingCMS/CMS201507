...
namespace SSOA.Services.Stores
{
    ...
    public partial class StoreService : IStoreService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string STORES_ALL_KEY = "SSOA.stores.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : store ID
        /// </remarks>
        private const string STORES_BY_ID_KEY = "SSOA.stores.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STORES_PATTERN_KEY = "SSOA.stores.";
