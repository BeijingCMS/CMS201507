...
namespace SSOA.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    ...
    {
        private readonly SSOAConfig _config;
        ...
        public UserAgentHelper(SSOAConfig config, IWebHelper webHelper, HttpContextBase httpContext)
        {
            this._config = config;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: http://www.SSOAcommerce.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            bool result = false;
            try
            {
