...
namespace SSOA.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ADDRESSATTRIBUTES_ALL_KEY = "SSOA.addressattribute.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string ADDRESSATTRIBUTES_BY_ID_KEY = "SSOA.addressattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : address attribute ID
        /// </remarks>
        private const string ADDRESSATTRIBUTEVALUES_ALL_KEY = "SSOA.addressattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string ADDRESSATTRIBUTEVALUES_BY_ID_KEY = "SSOA.addressattributevalue.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ADDRESSATTRIBUTES_PATTERN_KEY = "SSOA.addressattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ADDRESSATTRIBUTEVALUES_PATTERN_KEY = "SSOA.addressattributevalue.";
        #endregion
