...
namespace SSOA.Web.Framework.Security
{
    ...
    public class SSOAHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public SSOAHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                case SslRequirement.Yes:
                    {
                        ...
                        if (!currentConnectionSecured)
                        {
                            ...
                            if (storeContext.CurrentTenant.SslEnabled)
                            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new SSOAException("Not supported SslProtected parameter");
            }
        }
