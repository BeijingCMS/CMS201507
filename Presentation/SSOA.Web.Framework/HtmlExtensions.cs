...
namespace SSOA.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseSSOAEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseSSOAEntityModel
        {
        ...
        public static MvcHtmlString SSOALabelFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression, bool displayHint = true)
        {
            var result = new StringBuilder();
            var metadata = ModelMetadata.FromLambdaExpression(expression, helper.ViewData);
            var hintResource = string.Empty;
            object value;
            if (metadata.AdditionalValues.TryGetValue("SSOAResourceDisplayName", out value))
            {
                var resourceDisplayName = value as SSOAResourceDisplayName;
