...
namespace SSOA.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private const string CustomerCookieName = "SSOA.customer";
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
                ...
                if (detectedLanguage == null && _localizationSettings.AutomaticallyDetectLanguage)
                {
                    ...
                    if (!this.CurrentCustomer.GetAttribute<bool>(SystemCustomerAttributeNames.LanguageAutomaticallyDetected, 
                        _genericAttributeService, _storeContext.CurrentTenant.Id))
                    {
                        ...
                        if (detectedLanguage != null)
                        {
                            _genericAttributeService.SaveAttribute(this.CurrentCustomer, SystemCustomerAttributeNames.LanguageAutomaticallyDetected,
                                 true, _storeContext.CurrentTenant.Id);
                        }
                    }
                }
                if (detectedLanguage != null)
                {
                    ...
                    if (this.CurrentCustomer.GetAttribute<int>(SystemCustomerAttributeNames.LanguageId,
                        _genericAttributeService, _storeContext.CurrentTenant.Id) != detectedLanguage.Id)
                    {
                        _genericAttributeService.SaveAttribute(this.CurrentCustomer, SystemCustomerAttributeNames.LanguageId,
                            detectedLanguage.Id, _storeContext.CurrentTenant.Id);
                    }
                }

                var allLanguages = _languageService.GetAllLanguages(storeId: _storeContext.CurrentTenant.Id);
            ...
            set
            {
                ...
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    ...
                    languageId, _storeContext.CurrentTenant.Id);
        ...
        public virtual Currency WorkingCurrency
        {
            get
            {
                ...
                var allCurrencies = _currencyService.GetAllCurrencies(storeId: _storeContext.CurrentTenant.Id);
            ...
            set
            {
                ...
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    ...
                    currencyId, _storeContext.CurrentTenant.Id);
