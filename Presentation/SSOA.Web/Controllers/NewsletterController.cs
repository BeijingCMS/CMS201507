...
using SSOA.Web.Models.Newsletter;
    ...
    public partial class NewsletterController : BasePublicController
    {
        ...
        public ActionResult SubscribeNewsletter(string email, bool subscribe)
        {
            ...
            else
            {
                ...
                var subscription = _newsLetterSubscriptionService.GetNewsLetterSubscriptionByEmailAndStoreId(email, _storeContext.CurrentTenant.Id);
