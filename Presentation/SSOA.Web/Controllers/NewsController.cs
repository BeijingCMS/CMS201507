...
namespace SSOA.Web.Controllers
{
    ...
    public partial class NewsController : BasePublicController
    {
        ...
        public NewsController(INewsService newsService, 
            IWorkContext workContext, ITenantContext storeContext, 
        ...
        public ActionResult HomePageNews()
        {
            ...
            var cacheKey = string.Format(ModelCacheEventConsumer.HOMEPAGE_NEWSMODEL_KEY, _workContext.WorkingLanguage.Id, _storeContext.CurrentTenant.Id);
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
                var newsItems = _newsService.GetAllNews(_workContext.WorkingLanguage.Id, _storeContext.CurrentTenant.Id, 0, _newsSettings.MainPageNewsCount);
        ...
        public ActionResult List(NewsPagingFilteringModel command)
        {
            ...
            var newsItems = _newsService.GetAllNews(_workContext.WorkingLanguage.Id, _storeContext.CurrentTenant.Id,
        ...
        public ActionResult ListRss(int languageId)
        {
            var feed = new SyndicationFeed(
                                    string.Format("{0}: News", _storeContext.CurrentTenant.GetLocalized(x => x.Name)),
                                    "News",
            ...
            var newsItems = _newsService.GetAllNews(languageId, _storeContext.CurrentTenant.Id);
        ...
        public ActionResult NewsCommentAdd(int newsItemId, NewsItemModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SSOA.news.addcomment.result"] = _localizationService.GetResource("News.Comments.SuccessfullyAdded");
        ...
        public ActionResult RssHeaderLink()
        {
            ...
            string link = string.Format("<link href=\"{0}\" rel=\"alternate\" type=\"application/rss+xml\" title=\"{1}: News\" />",
                Url.RouteUrl("NewsRSS", new { languageId = _workContext.WorkingLanguage.Id }, _webHelper.IsCurrentConnectionSecured() ? "https" : "http"), _storeContext.CurrentTenant.GetLocalized(x => x.Name));
