...
using SSOA.Web.Framework.Security.Honeypot;
    ...
    public partial class CustomerController : BasePublicController
    {
            ...
            bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
        {
            ...
            if (!excludeProperties)
            {
                ...
                //newsletter
                var newsletter = _newsLetterSubscriptionService.GetNewsLetterSubscriptionByEmailAndStoreId(customer.Email, _storeContext.CurrentTenant.Id);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    if (_customerSettings.NewsletterEnabled)
                    {
                        ...
                        var newsletter = _newsLetterSubscriptionService.GetNewsLetterSubscriptionByEmailAndStoreId(model.Email, _storeContext.CurrentTenant.Id);
                        if (newsletter != null)
                        {
                            if (model.Newsletter)
                            {
                        ...
                        else
                        {
                            if (model.Newsletter)
                            {
                                _newsLetterSubscriptionService.InsertNewsLetterSubscription(new NewsLetterSubscription
                                {
                                    ...
                                    Email = model.Email,
                                    Active = true,
                                    StoreId = _storeContext.CurrentTenant.Id,
                ...
                try
                {
                    ...
                    if ((uploadedFile != null) && (!String.IsNullOrEmpty(uploadedFile.FileName)))
                    {
                        ...
                        if (uploadedFile.ContentLength > avatarMaxSize)
                            throw new SSOAException(string.Format(_localizationService.GetResource("Account.Avatar.MaximumUploadedFileSize"), avatarMaxSize));
