...
(function(){
    ...
    qq.basePrivateApi = {
        ...
        _generateExtraButtonSpecs: function() {
            ...
            qq.each(this._options.extraButtons, function(idx, extraButtoSSOAtionEntry) {
                var multiple = extraButtoSSOAtionEntry.multiple,
                    validation = qq.extend({}, self._options.validation, true),
                    extraButtonSpec = qq.extend({}, extraButtoSSOAtionEntry);
                ...
                if (extraButtonSpec.validation) {
                    qq.extend(validation, extraButtoSSOAtionEntry.validation, true);
                }
...
(function($) {
    "use strict";
    var $el,
        plugiSSOAtions = ["uploaderType", "endpointType"];
    ...
    function getNewUploaderInstance(params) {
        var uploaderType = plugiSSOAtion("uploaderType"),
            namespace = plugiSSOAtion("endpointType");
    ...
    function plugiSSOAtion(option, optionVal) {
    ...
    function transformVariables(source, dest) {
        ...
        $.each(source, function(prop, val) {
            if ($.inArray(prop, plugiSSOAtions) >= 0) {
                plugiSSOAtion(prop, val);
            }
