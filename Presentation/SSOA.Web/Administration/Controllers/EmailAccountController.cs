...
namespace SSOA.Admin.Controllers
{
	public partial class EmailAccountController : BaseAdminController
	{
		...
		public EmailAccountController(IEmailAccountService emailAccountService,
            ...
            IEmailSender emailSender, ITenantContext storeContext,
        ...
        public ActionResult SendTestEmail(EmailAccountModel model)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(model.SendTestEmailTo))
                    throw new SSOAException("Enter test email address");

                string subject = _storeContext.CurrentTenant.Name + ". Testing email functionality.";
