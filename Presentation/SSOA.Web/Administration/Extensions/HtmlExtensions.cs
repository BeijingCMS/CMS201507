...
namespace SSOA.Admin.Extensions
{
    ...
    {
        public static MvcHtmlString SSOAField<TModel>(this HtmlHelper<TModel> helper, 
            System.Linq.Expressions.Expression<Func<TModel, string>> expression)
        {
            return helper.SSOACommonField(expression, helper.TextBoxFor);
        }

        private static MvcHtmlString SSOACommonField<TModel, TValue>(this HtmlHelper<TModel> helper, 
            ...
            Func<System.Linq.Expressions.Expression<Func<TModel, TValue>>,MvcHtmlString> editor)
        {
            ...
            sb.Append(helper.SSOALabelFor(expression).ToHtmlString() + ":");
