...
{
    public partial class ProductReviewOverviewModel : BaseSSOAModel
    {
    ...
    public partial class ProductReviewsModel : BaseSSOAModel
    {
    ...
    public partial class ProductReviewHelpfulnessModel : BaseSSOAModel
    {
    ...
    public partial class AddProductReviewModel : BaseSSOAModel
    {
        [AllowHtml]
        [SSOAResourceDisplayName("Reviews.Fields.Title")]
        public string Title { get; set; }

        [AllowHtml]
        [SSOAResourceDisplayName("Reviews.Fields.ReviewText")]
        public string ReviewText { get; set; }

        [SSOAResourceDisplayName("Reviews.Fields.Rating")]
        public int Rating { get; set; }
