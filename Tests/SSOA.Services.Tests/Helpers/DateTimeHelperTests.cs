...
namespace SSOA.Services.Tests.Helpers
{
    [TestFixture]
    public class DateTimeHelperTests : ServiceTest
    {
        private IWorkContext _workContext;
        private ITenantContext _storeContext;
        ...
        public new void SetUp()
        {
            ...
            _storeContext = MockRepository.GenerateMock<ITenantContext>();
            _storeContext.Expect(x => x.CurrentTenant).Return(_store);
